...
///<param name="e"></param>
    ...
    public delegate void WebClientUploadEvent(object sender, HrtHttpServer.UploadEventArgs e);
...
///<param name="e"></param>
    ...
    public delegate void WebClientDownloadEvent(object sender, HrtHttpServer.DownloadEventArgs e);
...
//         byte[] filestream = new byte[512];
//         int real = s.Read(filestream, 0, 512);
//         string fileName = Tools.ParseFileName(url);
//         string localFile = localpath + fileName;
//         FileStream stream = new FileStream(localpath + "test.png", FileMode.Create);
//     }
}
