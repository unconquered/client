 ...
 namespace Com.Chinahrt.Exam.Dto {
	...
	public class TabSysDatadictInfo {
		...
		public TabSysDatadictInfo(String FDatadictId_0, String FParentdataId_1,
				String FDatadictName_2, String FDatasignName_3, String FDataValue_4,
				Int32 FSortCode_5, String FDictPath_6, String FDatadictDesc_7) {
			this.FDatadictId = FDatadictId_0;
			this.FParentdataId = FParentdataId_1;
			this.FDatadictName = FDatadictName_2;
			this.FDatasignName = FDatasignName_3;
			this.FDataValue = FDataValue_4;
			this.FSortCode = FSortCode_5;
			this.FDictPath = FDictPath_6;
			this.FDatadictDesc = FDatadictDesc_7;
		}
		...
		public void SetFDataValue(String FDataValue_0) {
			this.FDataValue = FDataValue_0;
		}
